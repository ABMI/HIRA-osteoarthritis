...
2. Create an empty folder or new RStudio project, and in `R`, use the following code to install the study package and its dependencies:
    ...
    download.file("https://raw.githubusercontent.com/ohdsi-studies/drn01/main/renv.lock", "renv.lock")
    renv::init()
    ```  
...
License
=======
The drn01 package is licensed under Apache License 2.0

Development
===========
drn01 was developed in ATLAS and R Studio.
