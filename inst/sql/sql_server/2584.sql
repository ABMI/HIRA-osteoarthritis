...
( 
  select concept_id from @vocabulary_database_schema.CONCEPT where concept_id in (1596977,1502826,1516766,43009055,1525215,1547504,45774435,40170911,793143,1583722,44506754,44785829,45774751,793293,43009020,43013884,43008991,43009051,43009089,40239216,40166035,1580747,43009070,19122137)
UNION  select c.concept_id
  from @vocabulary_database_schema.CONCEPT c
  join @vocabulary_database_schema.CONCEPT_ANCESTOR ca on c.concept_id = ca.descendant_concept_id
  and ca.ancestor_concept_id in (1596977,1502826,1516766,43009055,1525215,1547504,45774435,40170911,793143,1583722,44506754,44785829,45774751,793293,43009020,43013884,43008991,43009051,43009089,40239216,40166035,1580747,43009070,19122137)
  and c.invalid_reason is null
